...
void Test1() {
	...
	size_t sumTime = 0;
	Graph a;
	ofstream file1("C:/Users/stm_0/source/repos/MSN_Lab/MSN_Lab/cmake/test_1.1");
	...
	//sumTime = 0;
	ofstream file2("C:/Users/stm_0/source/repos/MSN_Lab/MSN_Lab/cmake/test_1.2");
	for (size_t num_vers = 1; num_vers <= 10000; num_vers += step) {
...
void Test2() {
	...
	size_t sumTime = 0;
	Graph a;
	ofstream file1("C:/Users/stm_0/source/repos/MSN_Lab/MSN_Lab/cmake/test_2.1.txt");
	...
	//cout << sumTime << "seconds;\n";
	//sumTime = 0;
	ofstream file2("C:/Users/stm_0/source/repos/MSN_Lab/MSN_Lab/cmake/test_2.2.txt");
	for (size_t num_vers = 101; num_vers <= 10000; num_vers += step) {
...
void Test3() {
	...
	size_t step = 100000;
	size_t sumTime = 0;
	ofstream file("C:/Users/stm_0/source/repos/MSN_Lab/MSN_Lab/cmake/test_3.txt");
...
void Test5() {
	...
	size_t sumTime = 0;
	Graph a;
	ofstream file1("C:/Users/stm_0/source/repos/MSN_Lab/MSN_Lab/cmake/test_4.1.txt");
	for (int maxweight = 1; maxweight <= 200; maxweight++) {
		num_edges = num_vers * num_vers;
		clock_t start_time = clock();

		a = Graph(num_vers, num_edges, maxweight);
		a.Kraskal();
	...
	for (size_t maxweight = 1; maxweight <= 200; maxweight++) {
		num_edges = num_vers * 1000;
		clock_t start_time = clock();
...
void Test4() {
	size_t num_vers = 10000;
	size_t num_edges = num_vers * num_vers;
	size_t step = 1;
	size_t sumTime = 0;
	Graph a;
	ofstream file1("C:/Users/stm_0/source/repos/MSN_Lab/MSN_Lab/cmake/test_4.1.txt");
